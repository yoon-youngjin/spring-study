...
class MemberRepositoryTest {
    ...
    @Test
    public void searchSimplePageTest() throws Exception {
        ...
        MemberSearchCondition condition = new MemberSearchCondition();
        PageRequest pageRequest = PageRequest.of(0, 3); // 0번 페이지에서 3개
    ...
    @Test
    public void searchComplexPageTest() throws Exception {
