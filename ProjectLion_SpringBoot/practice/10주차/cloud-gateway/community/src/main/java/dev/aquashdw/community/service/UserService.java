...
public class UserService {
    ...
    public UserService(
        ...
        userEntity.setUsername("yoon");
        userEntity.setPassword("pw");
        userEntity.setShopOwner(true);

        AreaEntity areaEntity = new AreaEntity();
        areaEntity.setRegionMajor("Aaa");
        areaEntity.setRegionMinor("BBB");
        areaEntity.setRegionPatch("aaaa");
        areaEntity.setLatitude(13.0);
        areaEntity.setLatitude(14.0);

        userEntity.setResidence(areaEntity);
